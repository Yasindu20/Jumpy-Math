export const load = {
  ...
  assets: () => {
    ...
    loadSprite("questionImage", "./assets/questionImage.png")
    loadSprite("player", "./assets/Player.png", {
      sliceX: 4, //Split the sprite sheet into 4 columns
      sliceY: 6, //Split the sprite sheet into 6 rows
      anims: {
        idle: { //player standing animations
          from: 0, //Start from frame 0
          to: 3, //Ends at frame 3
          loop: true, //loop this animation
        },
        run: { //player running animations
          from: 4, //Start from frame 4
          to: 7, //Ends at frame 7
          loop: true,
        },
        "jump-up": 8, //player jumping animation
        "jump-down": 9, //player jump down animation
      },
    })
    ...
    loadSprite("main-background", "./assets/Main_Background.png")
    loadSprite("forest-background", "./assets/Forest_Background_0.png")
    //load the grass tile image as a sprite sheet
    loadSprite("grass-tileset", "./assets/Grass_Tileset.png", {
      sliceX: 3, //splitting the sprite sheet into 3 columns
      sliceY: 4, //and 4 rows
      anims: {
        tl: 0,
        tm: 1,
    ...
    //oneway collusion that player can jump through
    ...
    loadSprite("water", "./assets/Water.png", {
      sliceX: 8, //8 frames in vertically
      sliceY: 1, //1 row
      anims: {
        wave: {
          from: 0, //animation start with first frame
          to: 7, //ends with 8th frame
          speed: 16, //animation speed
